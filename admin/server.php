...
//   $soalan = $_POST['addgambar']['soalan'];
//   $kategori = $_POST['addgambar']['kategori'];

//   $query =
//     "SELECT MAX(re_order) as max FROM user_dashboard";
...
//   $id = $_POST['editgambar']['id'];
//   $soalan = $_POST['editgambar']['soalan'];
//   $kategori = $_POST['editgambar']['kategori'];
