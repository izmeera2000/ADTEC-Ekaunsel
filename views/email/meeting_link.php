                        ...
                        <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                              ...
                              <tr>
                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                  ...
                                  <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                    align="left">
                                    Please join the meeting by clicking the link below:
                                  </p>
                                  <table class="s-4 w-full" role="presentation" border="0" cellpadding="0"
                                    cellspacing="0" style="width: 100%;" width="100%">
                                    <tbody>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td
                                          ...
                                          <a href="<?php echo $meeting_link ?? 'testmeetinglink' ?>"
                                            style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #0d6efd; padding: 12px; border: 1px solid #0d6efd;">Google Meet Link</a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                          ...
                          <!-- <table class="ax-center" role="presentation" align="center" border="0" cellpadding="0"
                            ...
                            <tbody>
                              <tr>
                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                  <img class="w-40" src="https://assets.bootstrapemail.com/logos/light/text.png"
