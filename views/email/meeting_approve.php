                              ...
                              <tr>
                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                  ...
                                  <h1 class="h3 fw-700"
                                    ...
                                    align="left">
                                    Temu Janji Anda Sudah Diluluskan
                                  </h1>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td
                                          ...
                                          <a href="<?php echo $link ?? 'testmeetinglink' ?>"
                                            style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #0d6efd; padding: 12px; border: 1px solid #0d6efd;">Maklumat Lanjut</a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
