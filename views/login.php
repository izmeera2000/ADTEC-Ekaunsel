          ...
          <div class="card-group d-block d-md-flex row">
            <div class="card col-md-7 p-4 mb-0">
              <form method="POST" action="login" enctype="multipart/form-data">
                ...
                <div class="card-body ">
                  ...
                  <div class="input-group mb-4 <?php formvalidatelabel("login", $errors) ?>"><span
            ...
            <div class="card col-md-5 text-white bg-primary py-5">
              <div class="card-body text-center">
                <div>
                  <h2>Register</h2>
                  <p>Mendapatkan akses kami dan nikmati pelbagai kelebihan yang kami tawarkan.</p>
                  <a class="btn btn-lg btn-outline-light mt-3" href="<?php echo $site_url ?>register">Register
                    Sekarang!</a>
                </div>
              </div>
            </div>
