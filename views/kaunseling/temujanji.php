                    ...
                    <div class="col-sm-10">
                      <div class="progress-group">
                        <div class="progress-group-header align-items-end">
                          ...
                          <div id="endtime" class="ms-auto font-weight-bold me-2"
                            data-time2="<?php echo date("Y-m-d H:i:s", strtotime($kaunselor_jadual['masa_tamat'])) ?>">
                            <?php echo date("H:i", strtotime($kaunselor_jadual['masa_tamat'])) ?>
                          </div>
                        </div>
                        <div class="progress-group-bars">
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <div class="card-subtitle text-body-secondary mb-4">
                      ...
                      $query =
                        "SELECT a.*, b.ndp, COUNT(a.id) FROM `kaunselor_jadual` a INNER JOIN user b ON a.user_id = b.id WHERE event_status ='4'  AND b.ndp ='$user_id ' ORDER BY a.id DESC ";
                      $results = mysqli_query($db, $query);
