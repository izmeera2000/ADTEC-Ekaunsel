        ...
        <div class="row align-items-xl-center gy-5">
          ...
          <div class="col-xl-7">
            <div class="row gy-4 icon-boxes">
              ...
              <div class="col-md-6 mb-md-2" data-aos="fade-up" data-aos-delay="300">
                <div class="icon-box">
        ...
        <div class="row gy-5 d-flex justify-content-center">
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="100">
            <div class="member-img">
              <img src="assets/img/team/pickauselor.jpg" class="img-fluid" alt="">
              <div class="social">
                <a href="mailto: nursyaza@adtectaiping.edu.my"><i class="bi bi-envelope"></i></a>
                <a href="tel: +60175896141"><i class="bi bi-telephone"></i></a>
                <!-- <a href="#"><i class="bi bi-instagram"></i></a>
                <a href="#"><i class="bi bi-linkedin"></i></a> -->
              </div>
            </div>
            <div class="member-info text-center">
              <h4>Puan Nur Syaza Hazwani Binti Zafrol</h4>
              <span>Pegawai Psikologi</span>
